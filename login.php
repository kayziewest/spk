...
<html>
	...
	<body >
		<div class='container-fliud'>
			<header class='row' id='header'>
				...
				<div class='col-md-8 text-center'>
					<h1 style='color: #fff;'>Havilla Portal Kit</h1>
				</div>
		...
		<footer>
			<div class='container'>
				<p class='text-center' style='color: #666;'>Copyright &#169; <?php echo $year ?> // Product of <a href='http://www.havillaroylaeschools.com'>Havilla Royale Schools.</a> // <span class='glyphicon glyphicon-envelope'></span> havillaroyaleschools2@gmail.com</p>
			</div>
		</footer>
	</body>
</html>