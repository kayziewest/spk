...
<html>
	...
	<body>
						...
						<?php
							...
							if(mysqli_num_rows($run_query) > 0){
								while($result = mysqli_fetch_assoc($run_query)){
									...
									echo"<p class='text-center'><b><marquee> Havilla Result Portal powered by Havilla </marquee></b></p>";
									
								}
							}
						?>
						<h2 class='text-center'><span class='glyphicon glyphicon-education'></span> HAVILLA ROYALE SCHOOLS STUDENT PORTAL </h2>
								...
								<div class='panel panel-primary'>
									...
									<div class='panel-body'>
										<div class='thumbnail jumbotron'>
											<h2>How are you {$student_lastname} ?</h2>
											<h3> Please read your message from the Head of IT, Havilla Royale Schools</h3>
											<p>Its been a long and stressful term, coupled with COVID-19 ruining our normal term schedule , I trust that you were happy to resume back with your classmates and learn again after such a long holiday, I hope you enjoy your christmas holiday and also utilize it to the maximum potential, when you resume I'll be specifically asking you to write me an essay on How you spent your Xmas holiday. I look forward to reading beautiful experiences from you. Enjoy yourself , Im very sure you'll be getting goodies from your parents. Be safe and wear your masks always when outside.
											<br>
											Merry Christmas and a wonderful year,<br>
											Best Regards,<br>
											Chikezie Sochi<br>
											Head of Information Technology, Havilla Royale Schools </p>
											<p><a class='btn btn-primary btn-xs' href='#' role='button'><span class='glyphicon glyphicon-search'></span> View more</a></p>
										</div>
									</div>
								</div>
							";
									...
									<div class='panel-body'>
										<div class='row'>
											...
											<div class='col-xs-8 col-sm-8 col-md-8 text-center'>
												<h2> HAVILLA ROYALE SCHOOLS</h2>
												<p class='text-danger'>
												23/27, Tedi-Muwo Road,Opposite Ojo Barracks, Lagos<br/> Telephone: 08037277308
												</p>
											</div>
										...
										<div class='row'>
											<div class='col-xs-12 col-md-12 text-center'>
												<em>
													...
													<br/>
													<span class='glyphicon glyphicon-phone'></span> 2348037277308</a>, 
													<span class='glyphicon glyphicon-envelope'></span> havillaroyaleschools2@gmail.com. 
								...
								<div class='panel panel-primary'>
									<div class='panel-body'>
										...
										//////////// POST ACTION TO DISPLAY CLASS MEMBERS ////////////////
											$query = " SELECT * FROM `students` WHERE `class` = '{$student_class}' LIMIT 30 ";
											$run_query = mysqli_query($connection, $query);
						...
						elseif(isset($_GET['logout'])){
							...
							echo"
								<div class='panel panel-primary'>
									...
									<div class='panel-body'>
										<div class='thumbnail jumbotron'>
											<h3>How are you {$student_lastname} ?</h3>
											<h4> Please read your message from the Head of IT, Havilla Royale Schools</h4>
											<p>Its been a long and stressful term, coupled with COVID-19 ruining our normal term schedule , I trust that you were happy to resume back with your classmates and learn again after such a long holiday, I hope you enjoy your christmas holiday and also utilize it to the maximum potential, when you resume I'll be specifically asking you to write me an essay on How you spent your Xmas holiday. I look forward to reading beautiful experiences from you. Enjoy yourself , Im very sure you'll be getting goodies from your parents. Be safe and wear your masks always when outside.
											<br>
											Merry Christmas and a wonderful year,<br>
											Best Regards,<br>
		...
		<footer>
			<div class='container'>
				<p class='text-center' style='color: #666;'>Copyright &#169; <?php echo $year ?> // Product of <a href='http://www.havillaroyaleschools.com'>Havilla Royale Schools</a> // <span class='glyphicon glyphicon-envelope'></span> havillaroyaleschools2@gmail.com</p>
			</div>
		</footer>
	</body>
</html>