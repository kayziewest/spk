...
<?php
	...
	if(mysqli_num_rows($run_query) == 2){
		while($result = mysqli_fetch_assoc($run_query)){
...
<html>
	<head>
		<title> HAVILLA ROYALE SCHOOLS<?php echo $result_name; ?></title>
		<meta charset='utf-8' />
		...
		<div class='container' id='result_page'>
			...
			<div class='row'>
				...
				<div class='col-md-8 col-sm-8 col-xs-8'>
					<h4 class='text-center'><b> HAVILLA ROYALE SCHOOLS </b></h4>
					<p class='text-center'><b> 23/27 TEDI MUWO ROAD, OPPOSITE OJO BARRACKS LAGOS </b></p>
					...
					<div class='row'>
						...
						<div class='col-md-6 col-sm-6 col-xs-6'>
							<h5><b>TERM ENDED:</b> "18th December, 2020 "</h5>
							<h5><b>NEXT TERM RESUMES:</b>"4th January, 2020" </h5>
						</div>
					</div>
				</div>
			...
			<?php
				...
				if($student_average >= 60){
					$teacher_remark = "Excellent Result <?php echo $result_name; ?>  Keep it Up.";
					$principal_remark = " I have watched you all through the term, and Im glad you impressed me so much.";
				}
				elseif($student_average >= 50){
					$teacher_remark = "Excellent Result,<?php echo $result_name; ?> But you can do better.";
					$principal_remark = "I know you can always do better , this is impressive.";
				}
				elseif($student_average >= 40){
					$teacher_remark = "Fair Result, <?php echo $result_name; ?> Please Work Harder.";
					$principal_remark = "Satisfactory, I need you to focus more on your academics.";
				}
				else{
					$teacher_remark = "Not Satisfied with your Result, <?php echo $result_name; ?> Work Harder.";
					$principal_remark = "I want you to put more effort, you are lagging behind in your academics.";
				}
			?>
			<div class='container'>
				<div class='row'>
