...
<html>
	...
	<body>
		...
		<footer>
			<div class='container'>
				<p class='text-center' style='color: #666;'>Copyright &#169; <?php echo $year ?> // Product of <a href='http://www.havillaroyaleschools.com.ng'>Havilla Royale Schools.</a> // <span class='glyphicon glyphicon-envelope'></span> havillaroyaleschools2@gmail.com</p>
			</div>
		</footer>
